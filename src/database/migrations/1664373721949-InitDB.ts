...
export class InitDB1664373721949 implements MigrationInterface {
    name = 'InitDB1664373721949';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE \`glossary\` (\`id\` int NOT NULL AUTO_INCREMENT, \`keyword\` varchar(255) NOT NULL, \`definition\` varchar(255) NOT NULL, \`serviceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE \`value_equipment_building\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(255) NOT NULL, \`buildingId\` int NULL, \`equipmentId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
            `CREATE TABLE \`equipment\` (\`id\` int NOT NULL AUTO_INCREMENT, \`label_equipment\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
            `CREATE TABLE \`value_equipment_site\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(255) NOT NULL, \`siteId\` int NULL, \`equipmentId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE TABLE \`value_item_site\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(255) NOT NULL, \`siteId\` int NULL, \`itemId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
            `CREATE TABLE \`item\` (\`id\` int NOT NULL AUTO_INCREMENT, \`label_item\` varchar(255) NOT NULL, \`default_value\` varchar(255) NULL, \`is_occupant_info\` tinyint NOT NULL, \`attachedServiceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
            `CREATE TABLE \`attached_service\` (\`id\` int NOT NULL AUTO_INCREMENT, \`label_attached_service\` varchar(255) NOT NULL, \`serviceId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
            `CREATE TABLE \`service\` (\`id\` int NOT NULL AUTO_INCREMENT, \`code_service\` varchar(255) NOT NULL, \`label_service\` varchar(255) NOT NULL, \`courseId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
        );
        await queryRunner.query(
