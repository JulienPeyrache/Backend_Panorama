...
export class initDB1664464558777 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`glossary\` (\`id\` int NOT NULL AUTO_INCREMENT, \`keyword\` varchar(255) NOT NULL, \`definition\` varchar(255) NOT NULL, \`serviceId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`value_equipment_site\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(255) NOT NULL, \`siteId\` int NOT NULL, \`equipmentId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`value_item_site\` (\`id\` int NOT NULL AUTO_INCREMENT, \`description\` varchar(255) NOT NULL, \`siteId\` int NOT NULL, \`itemId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`site_attached_services_attached_service\` (\`siteId\` int NOT NULL, \`attachedServiceId\` int NOT NULL, INDEX \`IDX_1103944c16818e4cd347afa6fd\` (\`siteId\`), INDEX \`IDX_f1b3c589b5a4f0df74f6442791\` (\`attachedServiceId\`), PRIMARY KEY (\`siteId\`, \`attachedServiceId\`)) ENGINE=InnoDB`);
